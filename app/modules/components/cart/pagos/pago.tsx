        ...
        <div className="lg:w-4/6 mx-auto">
          <div className="flex flex-col sm:flex-row mt-10">
            <div className="sm:w-2/3  sm:pl-8 sm:py-8 sm:border-r border-gray-200 sm:border-t-0 border-t mt-4 pt-4 sm:mt-0 text-center sm:text-left">
              <h2 className=' text-dark font-bold md:text-2xl'>Metodos de pago</h2>
              <div className="space-y-4 pt-4  ">
                <details className=" bg-white me-4 border border-gray-200 rounded-lg group [&_summary::-webkit-details-marker]:hidden" >
                  <summary className=" flex cursor-pointer items-center justify-between gap-1.5 rounded-lg bg-gray-50 p-4 text-gray-900">
                    <input type="checkbox" className=" me-4 size-5 rounded border-gray-300" id="Option3" />
                    <div className=" inline-flex font-medium">
                      ...
                      <span className=' ml-3 me-3 mt-2 font-light text-sm'>Envio a domicilio</span>
                    </div>
                ...
                <details className=" bg-white me-4  group [&_summary::-webkit-details-marker]:hidden">
                  <summary className="flex cursor-pointer items-center justify-between gap-1.5 rounded-lg bg-gray-50 p-4 text-gray-900">
                    <input type="checkbox" className=" me-4 size-5 rounded border-gray-300" id="Option3" />
                    <div className=" inline-flex font-medium">
