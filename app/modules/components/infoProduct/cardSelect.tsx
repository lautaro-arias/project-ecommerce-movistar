        ...
        <div>
          ...
          <div className="relative w-full rounded-lg max-w-lg">
            <div className="relative">
              <Image className="object-cover border border-gray-200 object-center mx-auto rounded-lg shadow-2xl" alt="hero" src={celular4}/>
            </div>
          </div>

        </div>
      </div>
     <div className="lg:w-1/2 w-full bg-white ml-5 lg:pl-10 lg:py-12 mt-6 lg:mt-0">
