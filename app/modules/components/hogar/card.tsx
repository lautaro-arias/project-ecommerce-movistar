      ...
      <section className="text-gray-600 body-font overflow-hidden">
        <div className="container px-5 py-12 mx-auto">
          ...
          <div className="flex flex-wrap justify-center mx-auto -m-4">
            <div className="p-4 flex-shrink-0 relative   overflow-hidden  xl:w-1/4 md:w-1/2 w-full">
            ...
            <div className=" flex-shrink-0 relative   overflow-hidden p-4 xl:w-1/4 md:w-1/2 w-full">
