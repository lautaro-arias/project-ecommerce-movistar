  ...
  return (
    <>
      <section className="text-gray-600 body-font">
        <div className=" mx-auto flex px-5 py-6 items-center justify-center ">
        ...
        <div className="container px-5 py-12 mx-auto">
          ...
          <div className="flex flex-wrap justify-center mx-auto -m-4">
            <div className="p-4 xl:w-1/4 md:w-1/2 w-full">
              <div className="shadow-xl h-full p-6 rounded-lg border-2 cursor-pointer hover:border-sky-500 border-gray-300 flex flex-col relative overflow-hidden group">
            ...
            <div className="p-4 xl:w-1/4 md:w-1/2 w-full">
              <div className=" shadow-2xl cursor-pointer h-full p-6 rounded-lg border-2 hover:border-sky-500 border-gray-300 flex flex-col relative overflow-hidden group">
            ...
            <div className="p-4 xl:w-1/4 md:w-1/2 w-full">
              <div className="shadow-xl hover:border-sky-400 cursor-pointer h-full p-6 rounded-lg border-2 border-gray-300 flex flex-col relative overflow-hidden group">
                <h2 className="inline-flex text-md tracking-widest title-font mb-4 font-medium">
