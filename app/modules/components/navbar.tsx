...
const Navbar = () => {
    ...
    return (
        <>
            <div className="navbar  justify-center bg-base-100 border-b border-gray-200 shadow-lg">
                ...
                <div className=" navbar-center hidden md:flex">
                    <ul className="menu  menu-horizontal  px-1">
                        {itemNav.map((item, index) => (
                            <li key={index} className='text-lg text-gray-600 font-light border-b border-white cursor-pointer hover:border-b ms-8 me-8 hover:border-cyan-400 hover:text-cyan-500 mt-2'>{item.name}</li>
                ...
                <div className="navbar-end me-2  md:me-20 xl:pe-80 ">
                    <div className="indicator cursor-pointer">
                        ...
                        <span className="hidden badge badge-sm indicator-item me-1 bg-red-500 text-white">0</span>
                    </div>
                </div>
            </div>
            <Carousels/>
