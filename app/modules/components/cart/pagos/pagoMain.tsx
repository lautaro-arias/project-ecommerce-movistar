            ...
            <div className="  container px-5 py-6 mx-auto flex flex-col">
              <div className="bg-white lg:w-4/6 mx-auto">
                <div className="flex flex-col sm:flex-row mt-10">
                  ...
                  <div className="  border pt-2  rounded-md  md:rounded-none md:border-none md:mt-0 sm:w-1/3 text-center  mt-40 sm:mt-0">
                            ...
                            <div className="w-screen max-w-lg space-y-4">
                              <dl className="space-y-0.5 text-sm text-gray-700">
                                <div className="m-2 flex justify-between">
                                  <dt>Subtotal</dt>
                                  <dd className="line-through text-gray-400 text-lg me-4 md:me-0">{product.price}</dd>
                                </div>
                                <div className="m-2 flex mb-4 justify-between">
                                  <dt>Descuento</dt>
                                  <dd className="bg-sky-400 rounded-lg me-4 md:me-0">-{product.discountPercentage}%</dd>
                                </div>
